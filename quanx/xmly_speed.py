...
cookies1 = "_xmLog=h5&34f98010-8467-4f99-92ac-71664685acb3&2.2.5; 1&_device=iPhone&5B188D84-8E6F-4A3E-AE21-C188894BD1AE&2.1.3; 1&_token=282920760&F1EFC940140CBEA69DD1CEA3751A91E9424AB1A43C2656D2509964334F73D08E7E9046A60545161M14FE18A68BF11CE_; NSUP=42EEE7B5%2C4200D46A%2C1615191998464; XUM=5B188D84-8E6F-4A3E-AE21-C188894BD1AE; ainr=0; c-oper=%E6%9C%AA%E7%9F%A5; channel=ios-b1; device_model=iPhone 7 Plus; idfa=FEDB0146-EB87-4D73-A267-3CB1026DB68F; impl=com.ximalaya.tingLite; ip=10.206.111.204; net-mode=WIFI; res=1242%2C2208"

cookies2 = "domain=.ximalaya.com; path=/; channel=ios-b1; impl=com.ximalaya.tingLite; 1&_device=iPhone&40FD0F96-65AB-4ACF-B18C-1AAC9B3DED5F&2.1.3; XUM=40FD0F96-65AB-4ACF-B18C-1AAC9B3DED5F; idfa=40FD0F96-65AB-4ACF-B18C-1AAC9B3DED5F; device_model=iPhone 11; c-oper=%E6%9C%AA%E7%9F%A5; net-mode=WIFI; ip=2409:8121:a820:e7c:ce:8405:100:0; res=828%2C1792; NSUP=; ainr=0; 1&_token=302166448&B931C1C0340C4D472290B921079EFC628E3AAC0D018CC56D2C2EC99E0D8BDE9732B90FF6B97D168MF6B1AC5BADB9722_"

cookies3 = "1&_device=iPhone&5B188D84-8E6F-4A3E-AE21-C188894BD1AE&2.1.8; 1&_token=307757305&72D8D240140C8FAA302FC3DA3B24D992ACD9125FE74B0B0F812985DB1F089D4528A5ABB6A53F29M14FE18A7F8A1A0A_; NSUP=; XUM=5B188D84-8E6F-4A3E-AE21-C188894BD1AE; ainr=0; c-oper=%E6%9C%AA%E7%9F%A5; channel=ios-b1; device_model=iPhone 7 Plus; idfa=00000000-0000-0000-0000-000000000000; impl=com.ximalaya.tingLite; ip=10.226.97.213; net-mode=4G; res=1242%2C2208; _xmLog=h5&fe7a1f81-3a6b-455f-baa9-4d77ca521160&2.2.5"
...
devices = []
notify_time = 11                            # 通知时间,24小时制,默认19
...
def run():
    ...
    if int(_notify_time.split()[0]) == notify_time and int(_notify_time.split()[1]) < 15:
        # if 1:
        message = ''
        for i in table:
